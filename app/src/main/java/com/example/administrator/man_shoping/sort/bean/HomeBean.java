package com.example.administrator.man_shoping.sort.bean;

import java.util.List;

/**
 * autour: 樊彦龙
 * date: 2017/10/23 15:06
 * update: 2017/10/23
 */
    ...
    public static class DataBean {
        ...
        public static class SubjectsBean {
            ...
            public static class GoodsListBeanX {
                 ...
                 * descrption : 三重植物精粹，三重水润膜力，美时美刻，水润透亮~
                 * description : 畅享鲜果派对，肌肤水嫩鲜活，萃取自然野草莓、黑莓、巴西莓精华，三款搭配持续水嫩鲜活~
                 */
